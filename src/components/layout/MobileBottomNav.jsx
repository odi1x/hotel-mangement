...
export default function MobileBottomNav({ view, setView, onNewBooking }) {
  ...
  return (
    <div className="md:hidden fixed bottom-4 inset-x-4 z-40 flex items-center gap-3">
      <div className="flex-1 flex items-center gap-1 bg-canvas dark:bg-surface-dark border border-hairline dark:border-hairline-dark rounded-full h-14 shadow-lift px-1">
        <TabItem
          icon={CalendarDays}
          label="التوفر"
