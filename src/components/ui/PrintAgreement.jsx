    ...
    <div className="fixed inset-0 bg-white z-[100] flex flex-col items-center p-10 overflow-y-auto" dir="rtl">
      <div className="max-w-3xl w-full bg-white border shadow-sm p-12 print:shadow-none print:border-none" id="agreement-paper">
        ...
        <div className="space-y-8 text-gray-800">
            <section>
                <h3 className="font-black text-sm bg-gray-100 p-2.5 uppercase mb-4 border-r-4 border-ink">أولاً: أطراف العقد</h3>
            ...
            <section>
                <h3 className="font-black text-sm bg-gray-100 p-2.5 uppercase mb-4 border-r-4 border-ink">ثانياً: العقار ومدة الإيجار</h3>
                <div className="grid grid-cols-2 gap-8">
                    <div>
                    ...
                    <div>
                        ...
                        <p className="text-sm font-black text-ink mt-1">{nights} ليلة إجمالية</p>
                    </div>
                </div>
            </section>

            <section>
                <h3 className="font-black text-sm bg-gray-100 p-2.5 uppercase mb-4 border-r-4 border-ink">ثالثاً: الشروط المالية</h3>
      ...
      <div className="mt-8 flex space-x-reverse space-x-4 print:hidden">
        <button
            onClick={handlePrint}
            className="bg-ink hover:bg-primary-active text-white px-8 py-3 rounded-md font-semibold flex items-center space-x-reverse space-x-2 transition-colors active:scale-95"
        >
            <Printer size={20}/>
