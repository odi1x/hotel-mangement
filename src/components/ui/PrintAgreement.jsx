...
export default function PrintAgreement({ booking, onClose }) {
  ...
  const total = parseFloat(booking.pricePerNight) * nights;
        ...
        <div className="space-y-8 text-gray-800">
            ...
            <section>
                ...
                <div className="grid grid-cols-3 gap-8">
                    ...
                    <div>
                        <p className="text-xs font-bold text-gray-400 uppercase mb-1">المبلغ الإجمالي</p>
                        <p className="text-xl font-black text-gray-900">{total} ر.س</p>
                    </div>
                    <div>
                        <p className="text-xs font-bold text-gray-400 uppercase mb-1">حالة الدفع</p>
                        <p className="text-sm font-black text-green-600">مؤكد / مدفوع</p>
                    </div>
                </div>
            </section>

            <section className="pt-10 border-t-2 border-dashed border-gray-200 mt-10">
                <p className="text-[11px] text-gray-500 font-medium leading-relaxed text-justify">
                ...
                <div className="flex justify-between mt-20 gap-20">
                    <div className="flex-1 border-t-2 border-gray-300 pt-3 text-center">
                        <p className="text-xs font-bold text-gray-500">توقيع المؤجر</p>
                    </div>
                    <div className="flex-1 border-t-2 border-gray-300 pt-3 text-center">
